...
> **This project is in beta and still in active development.**

**Just A Browser** (JAB) Fabric Mod adds live web screens to Minecraft. Build a wall of screen
...
**Multiplayer & Singleplayer** — the wall display is shared. When any player navigates, the URL change is
...
- **Craftable** — 4 screen blocks per craft (4 iron nuggets + 1 redstone dust). Breaks into an item
...
- Minecraft **1.21.11** or **1.21.1** (Fabric)
- [Fabric API](https://modrinth.com/mod/fabric-api)
- [Rinku](https://github.com/Keksuccino/Rinku) (`rinku-fabric`, `3.0.4`)
...
2. Look at the wall and run command:
...
3. After creating browser instance, right-click the wall with an **empty hand** to open the interactive browser view.

Breaking any block of a wall removes its display entirely. Browsers are only active near the player
...
- Each screen is a real Chromium instance — large walls or many simultaneous displays
  consume CPU and memory (obviously).
- First launch downloads Chromium binaries over the network, which may take
  minutes.
...
Each Minecraft version has its own branch. The jar filename includes the MC version
(e.g. `jab-mod-1.1.1-1.21.11.jar`).

| Branch   | Minecraft | Rinku              | Status            |
|----------|-----------|--------------------|-------------------|
| [`main`](https://github.com/RenderHam/jab-mod/tree/main) | — | — | Landing page |
| [`1.21.11`](https://github.com/RenderHam/jab-mod/tree/1.21.11) | 1.21.11 | `3.0.4-1.21.11` | Active development |
| [`1.21.1`](https://github.com/RenderHam/jab-mod/tree/1.21.1) | 1.21.1 | `3.0.4-1.21.1` | Beta |
| [`1.20.1`](https://github.com/RenderHam/jab-mod/tree/1.20.1) | 1.20.1 | `3.0.4-1.20.1` | Beta |
| [`1.19.2`](https://github.com/RenderHam/jab-mod/tree/1.19.2) | 1.19.2 | `3.0.4-1.19.2` | Beta |

To build for a specific version:

```bash
git clone https://github.com/RenderHam/jab-mod.git
cd jab-mod
git checkout <branch>        # e.g. 1.21.11
./gradlew build
```
...
Just A Browser Mod is developed with AI assistance. The majority of the
codebase was generated through AI-assisted development workflows, with human oversight
for code review, verification, and build processes. All code is reviewed, tested, modified, and
